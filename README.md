...
### In Progress (Planned Public Repos)
- `ai-automation-workflows`: reusable production-safe automation patterns
- `proxmox-homelab`: infrastructure setup, operations notes, and monitoring stack
- `christophevh.dev`: portfolio site and project case studies
